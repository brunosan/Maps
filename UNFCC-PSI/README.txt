...
3-Excel: Duplicate projects with several countries. Added ISO3 codes. exported to csv

4- Used QGIS to add the table to a shapefile with countries. Import and then "join" using the ISO3 tag.
